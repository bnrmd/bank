...
public class RegistrationForm {
	...
	public static void main(String[] args) {
		...
		String AccountType = null, AccountName, Gender = null, NationalID, Address, City, Province, 
		ZipCode, PhoneNo, Email, Education = null, MaritalStatus = null, Occupation, Signature, 
		...
		System.out.println("ClientID: " + ClientID.toUpperCase() + "                     Account Type: " + AccountType.toUpperCase());
		
		System.out.println("");
		System.out.println("i. Account Details \n");
		System.out.println("Account Name: " + AccountName.toUpperCase());
		System.out.println("Age: " + Age);
		System.out.println("Gender: " + Gender.toUpperCase());
		System.out.println("Nationality: CAN");
		System.out.println("National I.D.: " + NationalID);
		System.out.println("");
		
		System.out.println("");
		System.out.println("ii. Communication Details \n");
		System.out.println("Permanent Address: " + Address.toUpperCase());
		System.out.println("City: " + City.toUpperCase());
		System.out.println("Province: " + Province.toUpperCase());
		System.out.println("Country: CANADA");
		System.out.println("Zip Code: " + ZipCode.toUpperCase());
		System.out.println("Phone No.: +1 " + PhoneNo);
		System.out.println("E-Mail: " + Email);
		System.out.println("");
		
		System.out.println("");
		System.out.println("iii. Personal Details \n");
		System.out.println("Educational Details: " + Education.toUpperCase());
		System.out.println("Marital Status: " + MaritalStatus.toUpperCase());
		System.out.println("Occupation: " + Occupation.toUpperCase());
		System.out.println("");
		
		System.out.println("");
		System.out.println("iv. Verification \n");
		System.out.println("Signature (Initials): " + Signature);
	}
}